    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                logger.info(f"[INFO]: Tarefas criadas: {serializer.data['id']}")
                return Response(
                    serializer.data,
            ...
            return Response(
                {'error': '[ERROR]: Violação da integridade no banco de dados.'},
                status=status.HTTP_400_BAD_REQUEST
            )
...
class MinhaView(APIView):
    ...
    def get(self, request):
        return Response(f"Usuário autenticados: {request.user.username}", 
